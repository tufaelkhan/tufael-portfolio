...
const ToysProject = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center sm:text-left lg:text-left w-1/2 font-serif md:p-14">
      ...
      <a href="https://happy-education.web.app/" className='btn btn-outline btn-secondary mr-5 mb-2' target='blank'>Live site</a>
      <a href="https://github.com/tufaelkhan/toys-seals-client" className='btn btn-outline btn-secondary mr-5 mb-2' target='blank'>Client site</a>
