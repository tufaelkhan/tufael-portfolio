...
const MyProject = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center sm:text-left lg:text-left w-1/2 font-serif pl-10">
      ...
      <a href="https://language-school-e9e0d.web.app/" className='btn btn-outline btn-secondary mr-5' target='blank'>Live site</a>
      <a href="https://github.com/tufaelkhan/language-school-client" className='btn btn-outline btn-secondary mr-5' target='blank'>Client site</a>
